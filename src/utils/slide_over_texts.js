const slide_texts = {
  projectLength: {
    text:  '<p>While we hope your project will flourish for years, <span class="bold-intro-md">decades</span> (and even centuries!) to come - in order to understand better the costs, please let us know how many months your request for funding is meant to cover.</p>',
